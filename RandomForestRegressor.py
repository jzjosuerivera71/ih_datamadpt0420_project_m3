...
submission_df_3 = pd.DataFrame({'id': diamonds_predict['id'], 'price': y_pred})

submission_df_3.price.clip(0, 20000, inplace=True)

submission_df_3.to_csv('diamonds_rf_3.csv', index=False)
